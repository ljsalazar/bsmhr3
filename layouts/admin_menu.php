        ...
        <li>
          <a href="#" class="nav-link px-3">
            <span class="me-2"
              ><i class="bi bi-file-person-fill"></i
            ></span>
            <span>PerformanceManagement</span>
          </a>
        </li>
        <li>
          <a href="#" class="nav-link px-3">
...
<li>
    ...
    <div class="collapse" id="hr2">
      <ul class="navbar-nav ps-3">
        ...
        <li>
          <a href="hr2/ess_index.php" class="nav-link px-3">
            <span class="me-2"
              ><i class="bi bi-file-person-fill"></i
            ></span>
...
<!-- HR3 -->
  <li>
    ...
    <div class="collapse" id="hr3">
      <ul class="navbar-nav ps-3">
        <li>
          <a href="hr3/claim_index.php" class="nav-link px-3">
            <span class="me-2"
        ...
        <li>
          <a href="hr3/reimbursement_index.php" class="nav-link px-3">
            <span class="me-2"
              ><i class="bi bi-bag"></i
            ></span>
        ...
        <li>
          <a href="hr3/time_index.php" class="nav-link px-3">
            <span class="me-2"
        ...
        <li>
          <a href="hr3/schedule_management.php" class="nav-link px-3">
            <span class="me-2"
        ...
        <li>
          <a href="hr3/leave_management.php" class="nav-link px-3">
            <span class="me-2"
...
<li>
    ...
    <div class="collapse" id="hr4">
      <ul class="navbar-nav ps-3">
        <li>
          <a href="hr4/corehumancapital_index.php" class="nav-link px-3">
            <span class="me-2"
              ><i class="bi bi-file-person-fill"></i
            ></span>
        ...
        <li>
          <a href="#" class="nav-link px-3">
            <span class="me-2"
              ><i class="bi bi-file-person-fill"></i
            ></span>
            <span>Compensation Planning&Administration</span>
          </a>
        </li>
