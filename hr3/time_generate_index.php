				...
				<div class="col-md-12">
					<div class="panel">
						<div class="jumbotron text-center">
							...
							<form method="post" action="time_generate.php" enctype="multipart/form-data">
								<?php if ($user_level <= '1'): ?>
							...
							<button style="float:right; margin-right: 20px" name="cancel" class="btn btn-danger" onclick="location.href='timesheet_index.php'">Cancel</button>
						</div>
					</div>
				</div>
