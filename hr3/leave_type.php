          ...
          <!--<table class="table table-bordered" class="table table-sm table-striped table-bordered table-hover" style="width:100%">-->
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-left" ><?php echo read_date($row[3]); ?></td>
                <td>
                ...
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    <div class="modal-header bg-dark text-white">
                      <h6 class="modal-title" id="exampleModalLabel">ADD DETAILS</h6>
                                       </div>
                    <div class="modal-body">
                      <form action="add_leave_type.php" method="POST">
                      <div class="form-group">
                            <label for="leavetypes" class="control-label">Leave Type:</label>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form action="edit_leave_type.php" method="POST">
                        ...
                        <div class="form-group">
                          <label for="leavetypes" class="control-label">Name:</label>
