					...
					<div class="card-header">
						...
						<div class="card-body" id="pending">
							...
							<ul class="nav nav-pills">
								...
								<li role="presentation"><a href="reimbursement_history_rejected.php" class="btn" style="margin-bottom:10px"><b>Rejected</b></a></li>
							</ul>
								...
								<table id="example" class="table table-striped data-table" style="width:100%">
									...
									<?php
										...
										<?php
											...
											if ($user_level <= 2){
												echo "<td><a href='reimbursement_delete.php?reimbursement_id=$user_data[reimbursement_id]' class='btn btn-danger'data-toggle='tooltip' title='Remove'><i class='bi bi-eraser-fill'></i></a> <a href='reimbursement_accept.php?reimbursement_id=$user_data[reimbursement_id]' class='btn btn-success'data-toggle='tooltip' title='Accept'><i class='bi bi-check-circle-fill'></i></a> <a href='reimbursement_reject.php?reimbursement_id=$user_data[reimbursement_id]' class='btn btn-danger'data-toggle='tooltip' title='Reject'><i class='bi bi-x-circle-fill'></i></a></td>";
												} else {
