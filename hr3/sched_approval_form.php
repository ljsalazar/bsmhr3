...
// $result = $db->query($sql);
    ...
    $query.=" WHERE id = '{$l_id}'";
      if($db->query($query)){    
    $session->msg('s',"Schedule updated Successfully!");
    redirect('schedule_management.php', false);
     } else {
...
<?php echo display_msg($msg); ?>
    ...
    <div class="" style="width:90%">
       ...
       <a href="schedule_view.php?id=<?php echo (int)$_GET['id'] ?>" class="btn btn-danger">Cancel</a>
    </div>
