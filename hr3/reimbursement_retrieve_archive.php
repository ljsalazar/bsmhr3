<?php
	$page_title = 'Reimbursement Retrieve Prompt';
				...
				<div class="col-md-12">
					<div class="panel">
						<div class="jumbotron text-center">
							<?php
								if(isset($_POST['yes'])) {
									$query1 = $conn->query("INSERT INTO reimbursements SELECT * FROM reimbursements_archive WHERE reimbursement_id=$reimbursement_id");
