<?php
	$page_title = 'Event Delete Prompt';
						...
						<div class="jumbotron text-center">
							<?php
								if(isset($_POST['yes'])) {
									...
									$query = $conn->query("DELETE FROM events WHERE event_id=$event_id");
							...
							<button name="cancel" class="btn" onclick="location.href='time_index.php'">Cancel</button>
						</div>
					</div>
				</div>
