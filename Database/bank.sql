...
INSERT INTO `tblleaves` (`id`, `LeaveType`, `FromDate`, `ToDate`, `Description`, `PostingDate`, `AdminRemark`, `AdminRemarkDate`, `Status`, `IsRead`, `empid`, `emp_read`, `amount_of_days`, `remaining_days`) VALUES
(1, 'Vacation leave', '2021-12-15', '2021-12-19', 'I have to refresh myself, I am in a stressful scene of my life right now.', '2021-12-15', 'Okay', '2021-12-15 23:38:42 ', 1, 1, 7, 0, 5, 4),
(2, 'Sick Leave', '2021-12-06', '2021-12-10', 'Sick Leave', '2021-12-15', 'NO', '2021-12-16 0:26:23 ', 2, 1, 7, 0, 5, 0),
(3, 'Medical Leave', '2021-12-16', '2021-12-19', 'Medication', '2021-12-16', 'Ok', '2021-12-16 0:26:35 ', 1, 1, 7, 0, 4, 4),
